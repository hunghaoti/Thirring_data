...
plt.text(0.02, 1.05, '(a)', size=14)
plt.text(0.58, 1.05, '(b)', size=14)
plt.axis('off')
fig.set_figheight(5)
fig.set_figwidth(12)
...
cbar = fig.colorbar(CS, pad = 0.15, fraction=0.03)
...
#plt.tight_layout()
plt.subplots_adjust(hspace=0.35, wspace=0.27, left=0.015, right = 0.92)
